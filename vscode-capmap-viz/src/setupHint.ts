...
export const CAPMAP_SKILL_INSTALL_CMD =
...
export function formatDocsRootMissingMessage(projectRoot: string): string {
  return [
...
export function isDocsRootMissingCode(code: string | undefined | null): boolean {
  return code === DOCS_ROOT_MISSING_CODE
}

export function isDocsRootMissingMessage(message: string | undefined | null): boolean {
  if (!message) return false
  return (
    message.includes('未找到 docs_root') ||
